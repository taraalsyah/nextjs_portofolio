...
const CERTIFICATES: Certificate[] = [
  ...
  {
    id: 'meta-fe',
    title: 'Information Security Awareness Training for ISO 27001:2022',
    issuer: 'ISORB Security',
    issueDate: 'Maret 2025',
    expirationDate: 'No Expiration',
    credentialId: 'IS-0023/XII/ISORB/2024',
    verificationUrl: 'https://verify.meta.com/certificates/METAFE-2023-AJK-7741',
    category: 'Web Development',
    image: '/ISO.jpg',
    description: 'Completed a certified training program on Information Security Awareness aligned with the ISO 27001:2022 standard, covering key principles of information security management systems (ISMS), risk awareness, and best practices for protecting organizational data. The training was delivered and certified by Raul Bernardino, M.Sc., ISO 27001 Lead Auditor/Implementer and Trainer.',
    tags: ['ISO 27001', 'ISORB'],
